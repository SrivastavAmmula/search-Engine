...
def load_models():
    count_vectorizer = joblib.load(r"C:\Users\sriva\OneDrive\Desktop\inno\internship_jan_2024\Search Engine\models\count_vectorizer.joblib")
    tfidf_transformer = joblib.load(r"C:\Users\sriva\OneDrive\Desktop\inno\internship_jan_2024\Search Engine\models\tfidf_transformer.joblib")
    tfidf_matrix = joblib.load(r"C:\Users\sriva\OneDrive\Desktop\inno\internship_jan_2024\Search Engine\models\tfidf_matrix.joblib")
...
def main():
    st.title(' SmartSearch System ')

    data = load_data(r"C:\Users\sriva\OneDrive\Desktop\inno\internship_jan_2024\Search Engine\Search-Engine_final.csv")
